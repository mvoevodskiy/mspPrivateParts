...
class mspPrivatePartsOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('mspprivateparts_item_err_ns');
        }
...
return 'mspPrivatePartsOfficeItemUpdateProcessor';
