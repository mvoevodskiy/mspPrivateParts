...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('mspprivateparts_core_path', null,
                    $modx->getOption('core_path') . 'components/mspprivateparts/') . 'model/';
            $modx->addPackage('mspprivateparts', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/mspprivateparts/model/schema/mspprivateparts.mysql.schema.xml';
